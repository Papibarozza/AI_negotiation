...
public class Group39_BS_new extends OfferingStrategy {
	private SortedOutcomeSpace outcomespace;
	public Group39_BS_new(){}
...
//		System.out.println("Utility: "+utility);
		...
		if(time<=0.3 || opponentModel instanceof NoModel)
...
//		System.out.println("new Bid: "+newBid);
		...
		System.out.println(negotiationSession.getOpponentBidHistory().getLastBid());
